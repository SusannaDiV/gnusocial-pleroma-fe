  ...
  render() {
    ...
    return (
      ...
      <div className="w3-bar w3-theme-l2 w3-left-align w3-large">
        <a component={Link} to="/" className="w3-bar-item w3-button w3-padding-medium w3-theme-l2"><i className="w3-margin-right"></i><img src={logo} className="GNU-social-logo" alt="logo" width="105" height="33"/></a>
